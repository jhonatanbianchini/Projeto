...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">etot-front-end documentation</a>
                </li>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-4880c6eb4593982ecfdec5a63c3b3023"' : 'data-target="#xs-components-links-module-AppModule-4880c6eb4593982ecfdec5a63c3b3023"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-4880c6eb4593982ecfdec5a63c3b3023"' :
                                            'id="xs-components-links-module-AppModule-4880c6eb4593982ecfdec5a63c3b3023"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/AlunoCursosComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">AlunoCursosComponent</a>
                                            </li>
                                            <li class="link">
                                                <a href="components/ApoiadoresComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">ApoiadoresComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/AreaLoginComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">AreaLoginComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/FaleConoscoComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">FaleConoscoComponent</a>
                                            </li>
                                            <li class="link">
